...
const CasualStyleCard = ({ 
  onPress, 
  isSelected = false, 
  combinationCount = 0,
  imageUrl = 'https://images.unsplash.com/photo-1487222477894-8943e31ef7b2?w=400&auto=format&fit=crop&q=80',
  title = 'GÜNLÜK STİL'
}) => {
  return (
    <TouchableOpacity 
...
export default CasualStyleCard;