// 📁 src/screens/VitrinimScreen.js - DÜZELTİLMİŞ (mockData eklendi)
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity onPress={toggleSearch}><Ionicons name="search" size={22} color={COLORS.charcoal} /></TouchableOpacity>
      </View>
      {showSearch && (
